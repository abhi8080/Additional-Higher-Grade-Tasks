...
public class View {
    ...
    public void sampleExecution() {
        ...
        try {
            ...
            /**
             * Item identifier 111186021 does not exist in the inventory catalog. InvalidItemIdentifierException
             * will be thrown. 
             */
            /*System.out.println("Item with identifier 111186021 is scanned");
            System.out.println(controller.scanItem(111186021));
            */
            /**
             * Item identifier 431632620 causes a database failure. OperationFailedException
             * will be thrown. 
             */
            /*System.out.println("Item with identifier 431632620 is scanned");
              System.out.println(controller.scanItem(431632620));
            */
